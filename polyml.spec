...
Poly/ML jest pełną implementacją Standard ML dostępną jako
open-source. To wydanie wspiera wersję ML97 języka oraz bibliotekę
standardową (Standard Basis Library).
